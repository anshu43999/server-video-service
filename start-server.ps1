...
rtmp: false
hls: true
hlsAddress: 127.0.0.1:$MediaHlsPort
hlsVariant: lowLatency
hlsSegmentCount: 7
hlsSegmentDuration: 1s
hlsPartDuration: 200ms
webrtc: true
webrtcAddress: 127.0.0.1:$MediaWhepPort
webrtcLocalUDPAddress: 127.0.0.1:$MediaWebRtcUdpPort
...
"@
        ...
        $env:MEDIAMTX_WHEP_URL = "http://127.0.0.1:$MediaWhepPort"
        $env:MEDIAMTX_LLHLS_URL = "http://127.0.0.1:$MediaHlsPort"
        $env:MEDIAMTX_FFMPEG_PATH = $ffmpegPath
        $env:MEDIAMTX_VIDEO_ENCODER = "auto"

        Write-Step "MediaMTX 已启动：RTSP $MediaRtspPort / LL-HLS $MediaHlsPort / WHEP $MediaWhepPort"
    }
